...
#
# Generated by Vivado on Sun Mar 27 23:15:29 PDT 2022
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI] [get_bd_intf_pins rope_driver_0/S00_AXI]
  ...
  connect_bd_net -net bplssw_pg_0_1 [get_bd_ports bplssw_pg_0] [get_bd_pins rope_driver_0/bplssw_pg]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_timebase_wdt_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rope_driver_0/s00_axi_aclk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  ...
  connect_bd_net -net rope_driver_0_bplssw [get_bd_ports bplssw_0] [get_bd_pins rope_driver_0/bplssw]
  connect_bd_net -net rope_driver_0_ihenv [get_bd_ports ihenv_0] [get_bd_pins rope_driver_0/ihenv]
  connect_bd_net -net rope_driver_0_il [get_bd_ports il_0] [get_bd_pins rope_driver_0/il]
  connect_bd_net -net rope_driver_0_reset [get_bd_ports reset_0] [get_bd_pins rope_driver_0/reset]
  connect_bd_net -net rope_driver_0_roper [get_bd_ports roper_0] [get_bd_pins rope_driver_0/roper]
  connect_bd_net -net rope_driver_0_sbf [get_bd_ports sbf_0] [get_bd_pins rope_driver_0/sbf]
  connect_bd_net -net rope_driver_0_set [get_bd_ports set_0] [get_bd_pins rope_driver_0/set]
  connect_bd_net -net rope_driver_0_str [get_bd_ports str_0] [get_bd_pins rope_driver_0/str]
  ...
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs rope_driver_0/S00_AXI/S00_AXI_reg] -force
